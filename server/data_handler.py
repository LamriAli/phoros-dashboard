...
# An easy way to isolate databases is to avoid putting 
# the db instance inside the array
batch_databases = [Neo4j()] # Neo4j()
...
def handle_data(api,data,roadmap):
    ...
    # As a matter of fact, JUST DON'T USE IT AT ALL!!
    ...
    for item in graph.edges(data=True):
        ...
        for db in stream_databases:
            try:
                ...
                print (f"Error while inserting an edge {e}")
