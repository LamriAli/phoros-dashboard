...
var Iterator = _interopDefault(require('obliterator/iterator'));
var take = _interopDefault(require('obliterator/take'));
var chain = _interopDefault(require('obliterator/chain'));
...
function createEdgeIteratorForNode(type, direction, nodeData) {
  ...
  if (type !== 'undirected') {
    ...
    if (direction !== 'in' && typeof nodeData.out !== 'undefined') iterator = chain(iterator, createIterator(nodeData.out));
  }
...
function createEdgeIteratorForPath(type, direction, sourceData, target) {
  ...
  if (type !== 'undirected') {
    ...
    if (typeof sourceData.out !== 'undefined' && direction !== 'in' && target in sourceData.out) iterator = chain(iterator, createIteratorForKey(sourceData.out, target));
  }
...
function createNeighborIterator(type, direction, nodeData) {
  ...
  var iterator = Iterator.empty(); // Else we need to keep a set of neighbors not to return duplicates
